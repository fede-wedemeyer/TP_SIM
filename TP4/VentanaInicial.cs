    ...
    public partial class VentanaInicial : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                DataTable dt = simulacion.simular(N, mediaPrestamoLlegada, mediaDevolucionLlegada, mediaConsultaLlegada, mediaPCLlegada, mediaInfolegada, mostrarDesde, mediaPrestamo, mediaDevolucion, mediaConsulta, mediaPC, mediaInfo, mediaMembresia, probabilidadMembresia);
        ...
        public void simularConUnoMenos(string valorAnterior)
        {
            int N = int.Parse(cantIteraciones.Text);
            int mostrarDesde = int.Parse(desdeLinea.Text);
            ...
            VentanaNuevaSimulacion vd = new VentanaNuevaSimulacion(dt, resultados, valorAnterior);
            vd.generarDataGridView();
            vd.mostrarResultados();
            vd.ShowDialog();
